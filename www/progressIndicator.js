var ProgressIndicator = {
  ...
  showProgressBar: function(label, detail){
      label = label || "Please wait...";
      detail = detail || '';
      cordova.exec(null, null, "ProgressIndicator", "showProgressBar", [label, detail]);
  },
  ...
  setTitle: function(title){
      cordova.exec(null, null, "ProgressIndicator", "setTitle", [title]);
  },

  setMessage: function(message){
      cordova.exec(null, null, "ProgressIndicator", "setMessage", [message]);
  },
