...
/**
 * Progress BAR with LABEL and Detail
 */

- (void)showProgressBar:(CDVInvokedUrlCommand *)command {
    // obtain commands
...
/**
 * set Progress BAR with progress
 */
